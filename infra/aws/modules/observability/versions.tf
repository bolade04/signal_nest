# versions.tf — observability module tool + provider requirements
#
...
# established network/edge/alb/secrets/registry/storage/data_sql/data_cache/iam/
# ecs module convention.
