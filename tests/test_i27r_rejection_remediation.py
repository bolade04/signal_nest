...
EXPECTED_PRODUCTION_CONTROL_SITES = 870  # INFRA-9-B3 apply-identity: +3 (allow_model _sections_required/temporary_required_actions/w0_required_actions helpers; 0 removed)  # INFRA-9-B3: +29 (28 root_wiring_check.py function sites + 1 root_wiring graded step; 0 removed)  # BH-C-E1: +1 (collection_completeness.completeness_applicable helper for registry-derived completeness applicability)  # BH-C: +1 (critical_list_inventory._collection_value helper added by the F8 discovery extension)  # E2: +9 (site_coverage kind-aware redesign helpers x6 + ci_env_dataflow _denotes_environ/_ambient_allow_list + ci_harness _require_adequate_interpreter; 0 removed)
