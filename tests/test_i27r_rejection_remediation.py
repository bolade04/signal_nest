...
EXPECTED_PRODUCTION_CONTROL_SITES = 838  # BH-C-E1: +1 (collection_completeness.completeness_applicable helper for registry-derived completeness applicability)  # BH-C: +1 (critical_list_inventory._collection_value helper added by the F8 discovery extension)  # E2: +9 (site_coverage kind-aware redesign helpers x6 + ci_env_dataflow _denotes_environ/_ambient_allow_list + ci_harness _require_adequate_interpreter; 0 removed)
